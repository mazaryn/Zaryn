...
fn testnet_genesis(
	...
	endowed_zaryns: Vec<sr25519::Public>,
	_enable_println: bool
) -> GenesisConfig {
	// This prints upon creation of the genesis block
	println!("============ HELPER INPUTS FOR THE UI DEMO ============");
	println!("OUTPOINT (Alice's ZARYN Hash): 0x76584168d10a20084082ed80ec71e2a783abbb8dd6eb9d4893b089228498e9ff\n");
	...
	println!("NEW ZARYN HASH in UTXOStore onchain: 0xdbc75ab8ee9b83dcbcea4695f9c42754d94e92c3c397d63b1bc627c2a2ef94e6\n");
	...
	GenesisConfig {
		...
		zaryn: Some(ZarynConfig {
		  genesis_zaryns: endowed_zaryns
			.iter()
			.map(|x|
				zaryn::TransactionOutput {
					value: 100 as zaryn::Value,
