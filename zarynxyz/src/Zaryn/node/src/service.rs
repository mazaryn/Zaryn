...
use zaryn_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	zaryn_runtime::api::dispatch,
	zaryn_runtime::native_version,
);
...
pub fn build_inherent_data_providers(sr25519_public_key: sr25519::Public) -> Result<InherentDataProviders, ServiceError> {
	...
	providers
		.register_provider(zaryn_runtime::block_author::InherentDataProvider(
